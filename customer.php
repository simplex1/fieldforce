          ...
          <div class="col-md-3"></div>
           <div class="col-md-6">
              <form class="form-inline" method="POST" action="">
                <div class="row">
                  <input type="text" name="search_param" id="search_param" class="form-control" placeholder="Search : Enter outlet name / address / city etc" value="<?php echo $search;?>" style="width:69%;">
